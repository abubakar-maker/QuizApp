...
export const sidebarStyles = {
  ...
  levelButtonSelected: "border-current shadow-sm font-bold bg-gradient-to-r from-green-500 to-emerald-500 text-white",
...
export const resultStyles = {
  ...
  // Card styles
 card: "relative bg-white rounded-lg shadow-sm overflow-hidden border hover:shadow-md transition min-h-[120px] flex",
cardContent: "p-4 md:p-5 lg:p-4 flex-1 flex flex-col",
cardAccent: "w-1 bg-gradient-to-b from-indigo-400 to-indigo-700",     
